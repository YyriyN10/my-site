...
function scripts(){
  return src([//файли які потрібно об'єднати та зжати
    'js/bootstrap.js',
    'js/main.js'//завжди останній, важлива послідовність
  ])
    .pipe(concat('yuna-cabinet.min.js'))//ім'я згенерованого файлу
    .pipe(uglify())
...
function styles(){
  return src('css/style.scss')//шлях до файлу який потрібно конвертувати
    ...
    .pipe(concat('yuna-cabinet.min.css'))//Нова назва конвртованого та зжатого файлу

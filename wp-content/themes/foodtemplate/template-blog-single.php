<?php
	...
	get_header();?>
        ...
        <!-- Main screen -->
        <section class="post-main-screen main-screen main-screen--big indent-horizontal" style="background-image: url(<?php echo carbon_get_post_meta( get_the_ID(), 'food_blog_content_main_image');?>)">
          <div class="container-fluid">
            <div class="row">
              <div class="content col-12 text-center">
                <span class="button border-btn">
                    <?php
                      $post_id = get_the_ID();

	                    $categories = get_the_terms($post_id, 'blog_tax');

	                   echo $categories[0]->name;
                    ?>
                </span>
                <h1 class="small-title"><?php echo the_title();?></h1>
                <p class="post-info">
                  <span class="post-info__author-info">
                    <span class="post-info__avatar"><?php echo get_avatar(get_the_author_meta('ID'));?></span>
                    <span class="post-info__author-name"><?php echo get_the_modified_author();?></span>
        ...
        <?php if( $postBanner && $postBannerText ):?>
           <div class="banner col-12" style="background-image: url(<?php echo $postBanner;?>)">
             <div class="inner">
               ...
               <svg class="bg-pic" width="282" height="234" viewBox="0 0 282 234" fill="none" xmlns="http://www.w3.org/2000/svg">
